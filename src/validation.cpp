...
#if defined(NDEBUG)
# error "Apsiocoin cannot be compiled without assertions."
#endif
...
const std::string strMessageMagic = "Apsiocoin Signed Message:\n";
                              ...
                              bool bypass_limits, const CAmount& nAbsurdFee, std::vector<COutPoint>& coins_to_uncache)
{
...

    {
        ...
        {
            LogPrint(BCLog::MEMPOOL, "replacing tx %s with %s for %s APC additional fees, %d delta bytes\n",
...
void ThreadScriptCheck() {
    RenameThread("apsiocoin-scriptch");
