...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || gArgs.IsArgSet("-?") || gArgs.IsArgSet("-h") || gArgs.IsArgSet("-help"))
    {
        ...
        std::string strUsage = strprintf(_("%s apsiocoin-tx utility version"), _(PACKAGE_NAME)) + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  apsiocoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded apsiocoin transaction") + "\n" +
              "  apsiocoin-tx [options] -create [commands]   " + _("Create hex-encoded apsiocoin transaction") + "\n" +
              "\n";
