...
* apsiocoin.conf: contains configuration settings for apsiocoind or apsiocoin-qt
* apsiocoind.pid: stores the process id of apsiocoind while running
...
* debug.log: contains debug information and general logging generated by apsiocoind or apsiocoin-qt
